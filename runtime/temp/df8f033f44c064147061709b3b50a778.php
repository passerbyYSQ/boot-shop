<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:66:"D:\Wamp\www\shop\public/../application/admin\view\index\login.html";i:1590413091;}*/ ?>
﻿<!DOCTYPE html>
<!--
    ...
    <div class="login-container animated fadeInDown">
        ...
        <div class="loginbox bg-white" style="position:relative;">
            ...
            <div class="loginbox-social">
                <div class="social-title ">欢迎登录商城后台管理</div>
