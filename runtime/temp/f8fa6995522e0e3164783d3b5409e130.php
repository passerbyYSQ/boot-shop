<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:70:"D:\Wamp\www\shop\public/../application/index\view\member\register.html";i:1593855211;}*/ ?>

<!doctype html>
<html>
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>YSQ百货 - 注册</title>
		...
		<div class="loginRegister-header">
			<div class="w w1200">
				<div class="logo">
					<div class="logoImg">
						<a href="https://blog.csdn.net/qq_43290318"><img
							src="/shop/public/static/style/logo1.png" style="height: 90%;" /></a> <a
							href="https://blog.csdn.net/qq_43290318"><img
							src="/shop/public/static/style/ecsc-join.gif" /></a>
					</div>
					<div class="logo-span">
				...
				<div class="header-href">
					<span>已注册可<a href="<?php echo url('member/login'); ?>" class="jump">在此登录</a></span>
				</div>
			</div>
		</div>
		<div class="container">
			<div class="w w1200">
				<div class="register-wrap">
					<div class="register-adv">
						<a
							href="affiche.php?ad_id=456&amp;uri=https%3A%2F%2Fwww.dscmall.cn%2F"
							target="_blank"><img width="400" height="324"
							src="/shop/public/static/index/img/1488939821671881226.jpg" /></a>
					</div>
					<div class="register-form">
						<div class="form form-other">
							 <form action="<?php echo url('member/register'); ?>" method="post" name="formUser">
								<div class="item">
								...
								<div class="item">
									...
									<div class="item-info">
										<input type="password" style="display: none" /> <input
											type="password" name="password" id="pwd" class="text"
											value="" autocomplete="off" />
									</div>
									<div class="input-tip"></div>
								</div>
								<div class="item">
									...
									<div class="item-info">
										<input type="password" style="display: none" /> <input
											type="password" name="confirm_password" id="pwdRepeat"
											class="text" value="" autocomplete="off" />
									</div>
									<div class="input-tip"></div>
								</div>
								...
								<div class="item">
									...
									<div class="item-info">
										<input type="text" name="captcha" id="captcha" class="text" 
											value="" autocomplete="off" />
										<img style="position:absolute;top:0px;right:0px;" src="<?php echo captcha_src(); ?>" onClick="this.src='<?php echo captcha_src(); ?>'" />
									</div>
									<div class="input-tip"></div>
								</div>
								...
								<div class="item item2">
									<div class="item-checkbox">
										<input type="checkbox" id="clause2" class="ui-solid-checkbox"
											checked="checked" value="1" name="mobileagreement"> <label
											class="ui-solid-label" for="clause2">我已阅读并同意<a
											href="" class="ftx-05" target="_blank">《用户注册协议》</a></label>
									</div>
									<div class="input-tip"></div>
								</div>
		...
		<div class="dsc-copyright">
			<div class="w w1200">
				...
				<p class="copyright_info">
					ICP备案证书号:<a href="http://www.miibeian.gov.cn/" target="_blank">DSC00000123</a>
					POWERED BY<a href="http://www.dscmall.cn/" target="_blank">大商创</a>2.0
				</p>
			</div>
		</div>
