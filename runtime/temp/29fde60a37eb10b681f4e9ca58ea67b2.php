<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:68:"D:\Wamp\www\shop\public/../application/admin\view\category\list.html";i:1593922491;s:58:"D:\Wamp\www\shop\application\admin\view\common\navbar.html";i:1593923731;s:59:"D:\Wamp\www\shop\application\admin\view\common\sidebar.html";i:1593924689;}*/ ?>
<!DOCTYPE html>
<!--
...
<!-- /Navbar -->
    ...
    <div class="main-container container-fluid">
        ...
        <div class="page-container">
			...
			<?php $menu = 'category'; $submenu = 'list'; ?>
            <!-- Page Sidebar -->
			<!-- Page Sidebar -->
            ...
            <div class="page-content">
                ...
                <div class="dashboard-box" style="margin:16px;padding:16px">
                    <div id="editabledatatable_filter" class="dataTables_filter">
                    	...
                    	<form id='searchCateForm'>
                    	<label><input name="keyword" value="<?php echo \think\Request::instance()->get('keyword'); ?>" type="search" class="form-control input-sm" placeholder="根据分类名搜索" aria-controls="editabledatatable"></label>
                    	<a onclick="document:searchCateForm.submit()" class="btn btn-default" style="height:30px;margin-left:10px;">搜索</a>
                    	</form>
                    </div>
                    ...
                    <table class="table table-striped table-hover table-bordered dataTable no-footer" id="editabledatatable" role="grid" aria-describedby="editabledatatable_info">
                         <thead>
                             <tr role="row"><th class="sorting_asc" tabindex="0" aria-controls="editabledatatable" rowspan="1" colspan="1" aria-sort="ascending" aria-label="
                                 ...
                                 : activate to sort column descending" style="width: 191px;">
                                     ...
                                     Full Name
                                 : activate to sort column ascending" style="width:600px;">
                                     描述
                                 </th><th class="sorting" tabindex="0" aria-controls="editabledatatable" rowspan="1" colspan="1" aria-label="
                                     Points
                         ...
                         <?php foreach($cates as $cate): ?>
                         	<tr role="row" class="odd">
                                 ...
                                 <td><?php echo $cate['cateDesc']; ?></td>
                                 <td><?php echo $cate['sort']; ?></td>
                                 <td>
                                     <a href="<?php echo url('update'); ?>?id=<?php echo $cate['id']; ?>" class="btn btn-info btn-xs edit"><i class="fa fa-edit"></i> Edit</a>
                                     <a onClick="return confirm('是否确认删除？');" href="<?php echo url('delete'); ?>?id=<?php echo $cate['id']; ?>" class="btn btn-danger btn-xs delete"><i class="fa fa-trash-o"></i> Delete</a>
                                 </td>
                            </tr>
                         <?php endforeach; ?>
                         </tbody>
