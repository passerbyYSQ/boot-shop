<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:79:"D:\777\AppServ\www\boot-shop\public/../application/index\view\member\login.html";i:1606641685;s:70:"D:\777\AppServ\www\boot-shop\application\index\view\common\footer.html";i:1606641685;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
    ...
    <div class="row mt-2">
        ...
        <div class="col-lg-3 col-sm-4 col-12">
            <div class="shop-cart mt-4 float-right to-login">
                <a href="<?php echo url('member/register'); ?>">未有账号，去&nbsp;<em><b>注册</b></em></a>
            </div>
        </div>
    </div>
        ...
        <div class="col-md-4 offset-md-4 col-sm-8 offset-sm-2 px-2">
            <div class="card">
                <div class="card-body">
                    ...
                    <!-- 登录表单 -->
                    <form id="loginForm" action="<?php echo url('member/login'); ?>" method="post" onSubmit="return false;">
