<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:67:"D:\Wamp\www\shop\public/../application/admin\view\category\add.html";i:1593922480;s:58:"D:\Wamp\www\shop\application\admin\view\common\navbar.html";i:1593923731;s:59:"D:\Wamp\www\shop\application\admin\view\common\sidebar.html";i:1593924689;}*/ ?>
<!DOCTYPE html>
<!--
            ...
            <div class="page-content">
                ...
                <div class="dashboard-box" style="margin:16px;padding:16px">
                    <div class="collapse in">
                        <form id="addCateForm" role="form" action="<?php echo url('add'); ?>" method="post">
                        	<div class="row">
                        		<div class="col-lg-4 col-md-6 col-sm-8">
		                            <div class="form-group">
		                                <label for="definpu">类别名称</label>
		                                <input name="cateName" type="text" class="form-control" id="definput" placeholder="类别名称必填">
		                            </div>
	                            </div>
                            </div>
                            <div class="row">
                        		<div class="col-lg-6 col-md-8 col-sm-10">
		                            <div class="form-group" >
		                                ...
		                                <textarea name="cateDesc" class="form-control" rows="10" placeholder="描述可为空" ></textarea>
		                            </div>
                            	</div>
                            </div>
								...
								<div class="col-lg-2 col-sm-4">
									<label for="exampleInputEmail2">排序</label>
	                                 <div class="spinbox spinbox-horizontal spinbox-two-sided">
	                                     ...
	                                     <input name="sort" value="0" type="text" class="spinbox-input form-control">
                            ...
                            <a onclick="document:addCateForm.submit();" class="btn btn-default purple" style="margin-top:16px;" >
                            	保存
                            </a>
