<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:67:"D:\Wamp\www\shop\public/../application/admin\view\goods\update.html";i:1593922543;s:58:"D:\Wamp\www\shop\application\admin\view\common\navbar.html";i:1593923731;s:59:"D:\Wamp\www\shop\application\admin\view\common\sidebar.html";i:1593924689;}*/ ?>
<!DOCTYPE html>
<!--
                ...
                <div class="dashboard-box" style="margin:16px;padding:16px">
					<div class="widget-main ">
                       <div class="tabbable">
                          ...
                          <form id="addGoodsForm" action="<?php echo url('goods/update'); ?>" method="post" enctype="multipart/form-data">
                              ...
                              <div id="home11" class="tab-pane active">
                                ...
                                <div class="row">
	                        		<div class="col-lg-6 col-md-8 col-sm-10">
			                            <div class="form-group">
			                                ...
			                                <input name="goodsName" value="<?php echo $goods['goodsName']; ?>" type="text" class="form-control" id="definput" placeholder="类别名称必填">
			                            </div>
		                            </div>
	                            ...
	                            <div>
                                    ...
                                    <label style="margin-top:8px;margin-left:8px;">
                                        <input name="onSale" <?php if($goods['onSale'] == '1'): ?>checked="checked"<?php endif; ?> id="onsale" class="checkbox-slider slider-icon colored-blue" type="checkbox">                            
                                ...
                                <div class="row">
		                            <div class="col-lg-4 col-md-6 col-sm-8">
		                                    ...
		                                    <select name="cateId" id="e1" style="width:100%;" tabindex="-1" class="select2-hidden-accessible" aria-hidden="true">
		                                        ...
		                                        <option <?php if($goods['cateId'] == $cate['id']): ?>selected="selected"<?php endif; ?> value="<?php echo $cate['id']; ?>"><?php echo $cate['cateName']; ?></option>
		                                        <?php endforeach; ?>
		                                    </select>								
	                               	</div>
                           		</div>
									...
									<div class="col-lg-2 col-sm-4">
										<label for="exampleInputEmail2">市场价</label>
		                                 <div class="spinbox spinbox-horizontal spinbox-two-sided">
		                                     ...
		                                     <input name="marketPrice" value="<?php echo $goods['marketPrice']; ?>" type="text" class="spinbox-input form-control">
		                             ...
		                             <div class="col-lg-2 col-sm-4">
										<label for="exampleInputEmail2">现价</label>
		                                 <div class="spinbox spinbox-horizontal spinbox-two-sided">
		                                     ...
		                                     <input name="salePrice" value="<?php echo $goods['salePrice']; ?>" type="text" class="spinbox-input form-control">
		                                     <div class="spinbox-buttons	btn-group spinbox-buttons-right">
		                                         <button type="button" class="btn spinbox-up blue">
		                                             <i class="fa fa-plus"></i>
		                                         </button>
		                             ...
		                             <div class="col-lg-2 col-sm-4">
										<label for="exampleInputEmail2">库存</label>
		                                 <div class="spinbox spinbox-horizontal spinbox-two-sided">
		                                     ...
		                                     <input name="count" value="<?php echo $goods['count']; ?>" type="text" class="spinbox-input form-control">
		                                     <div class="spinbox-buttons	btn-group spinbox-buttons-right">
		                                         <button type="button" class="btn spinbox-up blue">
		                                             <i class="fa fa-plus"></i>
		                                         </button>
                           		...
                           		<a onClick="submit()" class="btn btn-default shiny" style="margin-top:32px;">保存修改</a>
                              	
                              </div> <!-- Tab1 -->
								
                              <div id="profile11" class="tab-pane">
                                  <div class="widget-main no-padding">
                                  		<div id="summernote" ><?php echo $goods['details']; ?></div>
