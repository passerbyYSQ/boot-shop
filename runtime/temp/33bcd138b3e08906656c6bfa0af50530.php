<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:66:"D:\Wamp\www\shop\public/../application/index\view\goods\index.html";i:1590933314;s:56:"D:\Wamp\www\shop\application\index\view\common\head.html";i:1590931476;s:57:"D:\Wamp\www\shop\application\index\view\common\right.html";i:1590931476;s:58:"D:\Wamp\www\shop\application\index\view\common\footer.html";i:1590931476;}*/ ?>
<!doctype html>
<html>
<head>
...
<li><a href="category.php?id=455">大码女装</a></li>
			...
			<i class="iconfont icon-right"></i>		</div>
<span class="cn-goodsName">goodsInfo.goods_name</span>
			</div>
</div>
        </div>
    </div>
...
<div class="preview" if="preview">
	<div class="gallery_wrap"><a href="" class="MagicZoomPlus" id="Zoomer" rel="hint-text: ; selectors-effect: false; selectors-class: img-hover; selectors-change: mouseover; zoom-distance: 10;zoom-width: 400; zoom-height: 474;"><img src="" id="J_prodImg" alt="韩美格2017春秋新款修身大码蕾丝网纱打底衫女长袖薄款圆领女T恤 全店商品 二件减5元 三件减10"></a></div>
	<div class="spec-list">
		...
		<div class="spec-items">
			<ul>
				<?php if(is_array($goodsPhotoRes) || $goodsPhotoRes instanceof \think\Collection || $goodsPhotoRes instanceof \think\Paginator): $i = 0; $__LIST__ = $goodsPhotoRes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$midphotos): $mod = ($i % 2 );++$i;?>
            	 <li>
					<a href="" rel="zoom-id: Zoomer" rev="__uploads__/<?php echo $midphotos['big_photo']; ?>" >
...
<div class="si-warp"><div class="m-price" id="ECS_MARKETPRICE"><em>¥</em>goodsInfo.markte_price</div></div>
                </div>
            <div class="si-info">
        ...
        <div class="summary-basic-info">
                ...
                <div class="summary-item is-integral">
                    ...
                    <div class="si-warp">
                        ...
                        <label <?php if($i == 1): ?> class="checkstatus" <?php endif; ?>><input <?php if($i == 1): ?> checked="checked" <?php endif; ?> type="radio" name="attr_attr.attr_id" value="">[加元][减元]<i></i></label>
                        <?php endforeach; endif; else: echo "" ;endif; ?>
                    </div>
                </div>
                <?php endforeach; endif; else: echo "" ;endif; ?>
...
<span>库存&nbsp;<em id="goods_attr_num" ectype="goods_attr_num"></em>&nbsp;个</span>
        ...
        <a href="javascript:bool=0;addToCart(goodsInfo.id)" data-type="0" class="btn-buynow" ectype="btn-buynow">立即购买</a>
    <a href="javascript:bool=0;addToCartShowDiv(goodsInfo.id);" class="btn-append" ectype="btn-append"><i class="iconfont icon-carts"></i>加入购物车</a>
