<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:54:"D:\Wamp\www\shop/application/admin\view\goods\add.html";i:1593965924;s:58:"D:\Wamp\www\shop\application\admin\view\common\navbar.html";i:1593923731;s:59:"D:\Wamp\www\shop\application\admin\view\common\sidebar.html";i:1593924689;}*/ ?>
<!DOCTYPE html>
<!--
            ...
            function sendFile(file, editor, $editable) {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                    	...
                    	if (data['result'] === true) {
                    		//console.log(true);
                    		editor.insertImage($editable,  "/shop/" + data['save_path']);
