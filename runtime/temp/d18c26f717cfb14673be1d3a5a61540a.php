<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:67:"D:\Wamp\www\shop\public/../application/index\view\member\login.html";i:1593854963;}*/ ?>
...
<body class="bg-ligtGary">
		...
		<div class="loginRegister-header">
			<div class="w w1200">
				...
				<div class="header-href">
					<span>还没有账号<a href="<?php echo url('member/register'); ?>" class="jump">免费注册</a></span>
				</div>
			</div>
		</div>
		<div class="container" >
			<div class="login-wrap">
				<div class="w w1200">
					<div class="login-form">
						...
						<div class="login-box">
							...
							<div class="form">
								<form id="loginForm" name="formLogin" action="<?php echo url('member/login'); ?>"
									method="post">
									<div class="item">
										<div class="item-info">
									...
									<div class="item">
										<div class="item-info">
											<i class="iconfont icon-password"></i><input type="text"
												...
												id="captchaImg" src="<?php echo captcha_src(); ?>"
				...
				<a class="login-banner" href="javascript:void(0);"
					style="background: url(/shop/public/static/index/img/1488936109167439630.jpg) center center no-repeat;"></a>
	...
	<script type="text/javascript"
		src="/shop/public/static/index/js/jquery.SuperSlide.2.1.1.js"></script>
	<script type="text/javascript"
		src="/shop/public/static/index/js/perfect-scrollbar.min.js"></script>
	<script type="text/javascript"
		src="/shop/public/static/index/js/jquery.validation.min.js"></script>
	<script type="text/javascript" src="/shop/public/static/index/js/jquery.purebox.js"></script>

	<script
		src="/shop/extend/SliderCaptcha/lib/twitter-bootstrap/js/bootstrap.bundle.js"></script>
